...
const Popular = () => {
  ...
  return (
    <div className='mt-3 md:hidden lg:block xl:block 2xl:block'>
      <span className='text-lg font-black sm:mx-6 py-2 text-gray-800'>Popular</span >
      <Slider {...settings} className='sm:mx-5 sm:w-full md:w-full lg:w-full xl:w-full 2xl:w-full w-[100%] rounded mb-2 my-3 '>
        {cardData.map((card) => (
      ...
      <h2 className='text-lg font-bold text-gray-800'>Headline3</h2>
